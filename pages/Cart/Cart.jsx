      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.project}>
          <div className={styles.shop}>
            ...
            <Image src={img5} className={styles.img2} />
              <div className={styles.content}>
                ...
                <h4>Price: $40</h4>
                <p className={styles.unit}>Quantity: <input name defaultValue={2} /></p>
                <p className={styles.btnarea}><DeleteIcon /> <span className="btn2">Remove</span></p>
              </div>
            </div>
            ...
            <div className={styles.content}>
                <h3>Man's Watches</h3>
                <h4>Price: $40</h4>
                <p className={styles.unit} >Quantity: <input name defaultValue={1} /></p>
                <p className={styles.btnarea}><DeleteIcon /> <span className="btn2">Remove</span></p>
            ...
            <div className={styles.content}>
                ...
                <h4>Price: $40</h4>
                <p className={styles.unit} >Quantity: <input name defaultValue={1} /></p>
                <p className={styles.btnarea}><DeleteIcon className={styles.ico} /> <span className="btn2">Remove</span></p>
          ...
          <div className={styles.rightbar}>
            ...
            <hr />
            <p><span>Total</span> <span>$141</span></p><a href="#"><ShoppingCartIcon className={styles.del} />Checkout</a>
          </div>
        </div>
      </div>
    </div>
