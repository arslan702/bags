    ...
    <div className={styles.navbar} id='navbar'>
      ...
      <div className={styles.navcontainer}>
        ...
        <ul className={styles.bottomnavcontainer}>
          <li>  <Link href='/' className={styles.pink} >All</Link></li>
          <li>  <Link href='/aboutUs' className={styles.pink} >New Arrivals</Link></li>
          <li>  <Link href='/products' className={styles.pink} >Hand Bags</Link>
          ...
          <li>  <Link href='' className={styles.pink} >Shoulder Bags</Link>
          {/* <div className={styles.submenu}>
                  <ul>
          ...
          <li>  <Link href='' className={styles.pink}>Backpacks</Link></li>
          <li>  <Link href='/contact' className={styles.pink} >Cross body bag</Link></li>
...
<ShoppingCartIcon/>
      ...
      >
        <ul>
          <li>  <Link href='/' className={styles.pink}  onClick={() => setMenuOpen(!menuOpen)}>All</Link></li>
          <li>  <Link href='/aboutUs' className={styles.pink}  onClick={() => setMenuOpen(!menuOpen)}>New Arrivals</Link></li>
          <li>  <Link href='' className={styles.pink}  onClick={() => setMenuOpen(!menuOpen)}>Hand Bags</Link>
          <div className={styles.submenu}>
                  <ul>
                    <li className={styles.dropdown}>Rice</li>
                    <li className={styles.dropdown}>Meat</li>
          ...
          <li>  <Link href='/' className={styles.pink}  onClick={() => setMenuOpen(!menuOpen)}>Shoulder Bags</Link></li>
          <li>  <Link href='/cash' className={styles.pink}  onClick={() => setMenuOpen(!menuOpen)}>Back packs</Link></li>
          <li>  <Link href='/contact' className={styles.pink}  onClick={() => setMenuOpen(!menuOpen)}>Cross body bag</Link></li>
