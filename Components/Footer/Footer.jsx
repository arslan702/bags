...
<Typography variant='h4' px={2} className={styles.footerheader} >About the Shop</Typography>
<Typography className={styles.about} pt={1}> abc is one of the with a wide range of premium quality makeup products to provide the best value for money to global customers</Typography>
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={6} lg={3} className={styles.footerdetail} >
              ...
              <Typography variant='h6' className={styles.menudetails} >All</Typography>
              <Typography variant='h6'  className={styles.menudetails}>New Arrival</Typography>
              <Typography variant='h6'  className={styles.menudetails}>Hand bags</Typography>
              <Typography variant='h6'  className={styles.menudetails}>Shoulder Bag</Typography>
              <Typography variant='h6'  className={styles.menudetails}>Backpack</Typography>
              <Typography variant='h6'  className={styles.menudetails}>Cross body bag</Typography>
...
<Grid>
  <Typography className={styles.footerrights} >All rights reserved @ 2023</Typography>
</Grid>
      </Container>
    </div>
  );
